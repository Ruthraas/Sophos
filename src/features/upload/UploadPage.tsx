        ...
        <CardContent className="flex flex-col gap-7 pt-6">
          <form className="flex flex-col gap-7" onSubmit={handleSubmit}>
            <div className="flex flex-col gap-5">
              ...
              <p className="-mt-3 min-h-[1rem] text-xs text-muted-foreground">
                {checkingDuplicate
                  ? 'Verificando se este livro já está no catálogo…'
                  : ' '}
              </p>
              {duplicate && (
                <div className="-mt-3 flex flex-col gap-1 rounded-md border-l-2 border-primary bg-primary/10 p-3 text-sm">
                  <p>
